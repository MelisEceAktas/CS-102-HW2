public class Tile {
    ...
    /*
     * (OMER): should check if the given tile t and this tile have the same value 
    ...
    /*
     * (OMER): should compare the order of these two tiles
    ...
    /*
     * (OMER): should determine if this tile and given tile can form a chain together
